  ...
  return (
    <section className="bg-white dark:bg-gray-900">
      <div className="py-6 px-4 mx-auto max-w-screen-xl lg:py6 lg:px-6">
        ...
        <div className="flex justify-center gap-8 mb-6 lg:mb-6">
          {partners.map((partner, index) => (
            <div
              key={index}
              className="flex flex-col items-center bg-gray-50 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
            >
              <div className="flex ">
