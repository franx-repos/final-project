...
const styles = {
  ...
  card: "max-w-64 p-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700",
  ...
  p: "h-28 flex mb-3 font-normal text-gray-700 dark:text-gray-400 overflow-auto ",
};
